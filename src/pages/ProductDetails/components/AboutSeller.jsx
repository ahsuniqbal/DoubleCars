                ...
                <Card className="mt-5 about-seller-card">
                    <CardBody>
                        ...
                        <div className='contact-details-div'>
                            <a  className = "contact-detail-text"><img src={ClockIcon} className='clock-icon-img' />9AM - 6AM</a>
                            <br/>
                            <a href={"mailto:" + dealer.email} className = "contact-detail-text"> <img src={PhoneIcon} className='phone-icon-img'/>{dealer.phNum}</a>
                            <br/>
                            <a href={"mailto:" + dealer.email} className = "contact-detail-text"><img src={MessageIcon} className='message-icon-img'/>{dealer.email}</a>
                            <br/>
                            <a   className = "contact-detail-text"><img src={AdrressPinIcon} className='address-icon-img'/>1144 St, Newroad, San Fransisco, CA</a>
                        </div>
