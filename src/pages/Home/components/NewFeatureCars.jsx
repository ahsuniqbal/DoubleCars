    ...
    return(
      <Container>
        ...
        <Row className='main-feature'>
            <Col data-aos="flip-down" data-aos-duration="1500" data-aos-easing="ease-in-sine" md = "6" xs = "12" style = {FeaturedDemoImage1} className='main-coloumn' onClick={()=>history.push('/product/'+ productId[0].productId)}>
            ...
            <Col md = "6" xs = "12">
                <Row>
                    <Col  data-aos="flip-down" data-aos-duration="1500" data-aos-easing="ease-in-sine"  md = "6" xs = "12" style = {FeaturedDemoImage2} className='main-coloumn' onClick={()=>history.push('/product/'+ productId[1].productId)}>
                    ...
                    <Col data-aos="flip-down" data-aos-duration="1500" data-aos-easing="ease-in-sine" md = "6" xs = "12" style = {FeaturedDemoImage3} className='main-coloumn'  onClick={()=>history.push('/product/'+ productId[2].productId)}>
                      <Badge color="primary" className = "feature-car-badge2">New</Badge>
                      <div className="content">
                ...
                <Row>
                    <Col data-aos="flip-down" data-aos-duration="1500" data-aos-easing="ease-in-sine" md = "6" xs = "12" style = {FeaturedDemoImage4} className='main-coloumn'  onClick={()=>history.push('/product/'+ productId[3].productId)}>
                    <Badge color="primary" className = "feature-car-badge2">New</Badge>
                      <div className="content">
                    ...
                    <Col data-aos="flip-down" data-aos-duration="1500" data-aos-easing="ease-in-sine" md = "6" xs = "12" style = {FeaturedDemoImage5} className='main-coloumn'  onClick={()=>history.push('/product/'+ productId[4].productId)}>
                     <Badge color="primary" className = "feature-car-badge2">New</Badge>
                      <div className="content">
