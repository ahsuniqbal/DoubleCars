...
const Filters = (props) => {
    ...
    const DrawBodyStyles = (bodyStyleList) => {
        ...
        if(bodyStyleList.includes('Hatchback')) {
            table.push(
                <Col onClick={() => bodyListFunc('Sedan',1)} xs="6" sm="4"md="6" lg='4' className="px-0">
        ...
        if(bodyStyleList.includes('SUV')) {
            table.push(
                <Col onClick={() => bodyListFunc('Sedan',2)} xs="6" md="6" lg='4'>
        ...
        if(bodyStyleList.includes('Covertibale')) {
            table.push(
                <Col onClick={() => bodyListFunc('Sedan',4)} xs="6" md="6" lg='4' className="px-0">
        ...
        if(bodyStyleList.includes('Sport Utility Vehicle')) {
            table.push(
                <Col onClick={() => bodyListFunc('Sedan',5)} xs="6" md="6" lg='4'>
        ...
        if(bodyStyleList.includes('Truck')) {
            table.push(
                <Col onClick={() => bodyListFunc('Sedan',6)} xs="6" md="6" lg='4'>
                    <svg width="55" height="25" viewBox="0 0 55 25" fill="none" xmlns="http://www.w3.org/2000/svg">
