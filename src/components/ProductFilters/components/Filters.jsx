...
const Filters = (props) => {
    ...
    //Selected color blue and gray
    const [selectedBodyStyle, setSelectedBodyStyle] = useState(false);
        ...
        <Card className="filters">
            <CardBody>
                ...
                <FormGroup check>
                    ...
                    <Label check htmlFor="new">Manual</Label>
                </FormGroup>
                <FormGroup check>
                    <Input type="checkbox" id="used" name="condition" />
                    <Label check htmlFor="used">Automatic</Label>
                </FormGroup>
